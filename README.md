...
3. Configure the application:
   ...
   - The `REF_CODE` parameter in `config.py` is used to set the referral code that appears in your referral link after `startapp=` in your referral link:
     ```python
     REF_CODE = 'DceesgPO'  # Set your referral code here
     ```
...
Thank you for using PAWS Telegram Bot! Don't forget to follow our [Telegram channel](https://t.me/petyasofts) for updates.
